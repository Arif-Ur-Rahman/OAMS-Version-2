...
function CategoryDetailsTable({ show, onHide, category }) {
    ...
    const columns = [
        ...
        {
            title: t('CategoryDetailsTable.1'), field: "AssetId", emptyValue: () => <em>null</em>, defaultSort: "asc", filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.2'), field: "AssetName", emptyValue: () => <em>null</em>, filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "20%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.3'), field: "EmployeeId", emptyValue: () => <em>null</em>, filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "20%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.4'), field: "AssetDetails", emptyValue: () => <em>null</em>, filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "20%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.5'), field: "Ram", emptyValue: () => <em>null</em>, filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.6'), field: "Cpu", emptyValue: () => <em>null</em>, filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.7'), field: "Hdd", emptyValue: () => <em>null</em>, filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.8'), field: "Ssd", emptyValue: () => <em>null</em>, filtering: false, editable: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
        // {
        ...
        // },
        {
            title: t('CategoryDetailsTable.9'), field: "IsOkay", emptyValue: () => <em>null</em>, filtering: false, lookup: { 0: "Defect", 1: "OK" },
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
        {
            title: t('CategoryDetailsTable.10'), field: "Comments", emptyValue: () => <em>null</em>, filtering: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "10%", textAlign: "left", }
        },
