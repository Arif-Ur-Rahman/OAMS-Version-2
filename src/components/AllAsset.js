...
function AllAsset() {
    ...
    const columns = [
        {
            title: t('AllAssets.1'), field: "CategoryId", emptyValue: () => <em>null</em>, sorting: true, filtering: false, editable: false,
        ...
        {
            title: t('AllAssets.4'), field: "AssetUsed", emptyValue: () => <em>null</em>, filtering: true, editable: false, headerStyle: (rowData) => {
