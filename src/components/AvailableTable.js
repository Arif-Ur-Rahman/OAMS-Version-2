...
function AvailableTable() {
    ...
    const columns = [
        ...
        {
            title: t('AvailableAssets.4'), field: "AssetName", emptyValue: () => <em>null</em>, filtering: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
        {
            title: t('AvailableAssets.5'), field: "AssetDetails", emptyValue: () => <em>null</em>, filtering: false,
            headerStyle: { textAlign: "left", paddingLeft: "15px", }, cellStyle: { width: "5%", textAlign: "left", }
        },
    ]
