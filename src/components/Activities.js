...
function Activities() {
    ...
    const columns = [
        {
            title: t('Activities.1'), field: "ActivityId", emptyValue: () => <em>null</em>, filtering: false, defaultSort: "asc",
        ...
        {
            title: t('Activities.5'), field: "AssetName", emptyValue: () => <em>null</em>, filtering: true,
            headerStyle: { textAlign: "left", paddingLeft: "15px", },
        },
        {
