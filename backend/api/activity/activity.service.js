...
module.exports = {
                                                ...
                                                (error3, results3, fields) => {
                                                    ...
                                                    pool.query(`UPDATE assets SET AssetExpired = 0;`,
                                                        (error4, results4, fields) => {
                                                            pool.query(`UPDATE asset_details SET UsedQuantity = 1;`,
    ...
    showGlobalActivityTable: (data, callBack) => {
        pool.query(`SELECT * FROM activity WHERE EmployeeId=0 ORDER BY ActivityTime DESC LIMIT 5;`,
            (error, results, fields) => {
                if (error) {
                    return callBack(error); 
                }
